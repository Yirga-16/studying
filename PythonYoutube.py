...
class SourceLoad:
    def __init__(self):
        self.pv_battery = np.array(
            [281, 257, 225, 182, 141, 106, 62, 20, 0, 0, 0, 0, 0, 0, 0, 0, 0, 26, 66, 111, 148, 186, 226,
             258]) * 10  # kW
        self.wp_battery = np.array(
            [19, 19, 19, 21, 28, 29, 31, 35, 36, 40, 44, 51, 58, 77, 98, 109, 96, 72, 53, 42, 40, 40, 35, 24]) * 10
